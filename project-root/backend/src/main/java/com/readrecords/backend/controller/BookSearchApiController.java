...
public class BookSearchApiController {
    ...
    public ResponseEntity<SearchBooksResponseDto> showSearchWindow(@RequestParam(required = false) String title,
            ...
            @RequestParam(required = false) String isbn, @RequestParam(value = "page", defaultValue = "1") Integer page)
            throws Exception {
    ...
    public ResponseEntity<?> registerRecords(@RequestBody Map<String, Object> requestData,
        ...
        // 登録情報一覧
        logger.info("ISBN: {}, book_name: {}, author: {}, genre: {}, publication_year: {}, publisher: {}", ISBN,
                book_name, author, genre, publication_year, publisher);
        // 書籍情報の登録
    ...
    private void registerBoookRecords(String ISBN, String book_name, String author, String genre,
            String publication_year, String publisher) {
        ...
        bookRecordsService.registerBookRecords(bookRecords.getISBN(), bookRecords.getBook_name(),
                bookRecords.getAuthor(), bookRecords.getGenre(), bookRecords.getPublication_year().toString(),
                bookRecords.getPublisher());
    }

    private String registerReadRecords(String userId, String ISBN, Date start_date, Date end_date, int read_count,
        ...
        // 読書情報の登録
        String message = readRecordsService.registerReadRecords(readRecords.getISBN(), readRecords.getUser_id(),
                readRecords.getStart_date().toString(), readRecords.getEnd_date().toString(),
                readRecords.getRead_count(), readRecords.getPriority(), readRecords.getMemo());
        return message;
    }
