...
public class BookRecordsServiceImpl implements BookRecordsService {
    ...
    @Override
    public void registerBookRecords(String ISBN, String book_name, String author, String genre, String publication_year,
            String publisher) {
        ...
        if (bookRecords.isEmpty()) {
            ...
            bookRecordsRepository.insertBookRecords(ISBN, book_name, author, genre, publication_year, publisher);
        }
    }
}
