...
public class ReadingAchievementsServiceImpl implements ReadingAchievementsService {
  ...
  int yearlyTotalBooks = readingRecordsRepository.getBooksCountByUserId(userId, yearlyCountEndDate);
  double yearlyPercentage = yearlyTotalBooks / yearlyGoal;
  ...
  int monthlyTotalBooks = readingRecordsRepository.getBooksCountByUserId(userId, monthlyCountEndDate);
